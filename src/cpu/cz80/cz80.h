...
#define CZ80_IRQSTATUS_NONE (0x00)
#define CZ80_IRQSTATUS_ACK  (0x10)
#define CZ80_IRQSTATUS_AUTO (0x20)
...
typedef struct
{
	...
	u8 *FetchData[CZ80_FETCH_BANK];
	u8 *Read[CZ80_FETCH_BANK];
	u8 *Write[CZ80_FETCH_BANK];
} cz80_struc;
...
//s32     FASTCALL Cz80_Exec(cz80_struc *cpu);
