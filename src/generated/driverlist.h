// This file was generated by src/scripts/gamelist.pl (perl 5.010000)
...
#if defined FBA_DEBUG
DRV		BurnDrvCpsDaimakb;		// no comment
#endif
DRV		BurnDrvDFeveron;
...
#if defined FBA_DEBUG
DRV		BurnDrvCpsForgott1;		// no comment [NOT WORKING]
#endif
DRV		BurnDrvGaia;
DRV		BurnDrvGalaxyfg;
DRV		BurnDrvGanryu;
...
DRV		BurnDrvCpsSf2j;
#if defined FBA_DEBUG
DRV		BurnDrvCpsSf2b;			// no comment
DRV		BurnDrvCpsSf2th;		// no comment
#endif
...
DRV		BurnDrvCpsSf2m2;
#if defined FBA_DEBUG
DRV		BurnDrvCpsSf2m3;		// no comment [NOT WORKING]
#endif
DRV		BurnDrvCpsSf2m4;
DRV		BurnDrvCpsSf2m5;
DRV		BurnDrvCpsSf2m6;
...
#if defined FBA_DEBUG
	&BurnDrvCpsDaimakb,			// Dai Makai-Mura (Japan, bootleg) [no comment]
#endif
...
#if defined FBA_DEBUG
	&BurnDrvCpsForgott1,		// Forgotten Worlds (World?) [no comment, NOT WORKING]
#endif
...
#if defined FBA_DEBUG
	&BurnDrvCpsSf2b,			// Street Fighter II - the world warrior (bootleg) [no comment]
	&BurnDrvCpsSf2th,			// Street Fighter II' - (Turbo Hack) [no comment]
#endif
...
#if defined FBA_DEBUG
	&BurnDrvCpsSf2m1,			// Street Fighter II' - champion edition (Hack - M-1) [no comment, NOT WORKING]
#endif
	&BurnDrvCpsSf2m2,			// Street Fighter II' - champion edition (Hack - M-2)
#if defined FBA_DEBUG
	&BurnDrvCpsSf2m3,			// Street Fighter II' - champion edition (Hack - M-3) [no comment, NOT WORKING]
#endif
...
#if defined FBA_DEBUG
	&BurnDrvCpsKodb,			// The King of Dragons (bootleg) [No Sprites, NOT WORKING]
#endif
