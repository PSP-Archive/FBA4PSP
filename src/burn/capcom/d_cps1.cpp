...
static struct BurnRomInfo KodbRomDesc[] = {
	{ "kod.17",        0x080000, 0x036dd74c, BRF_ESS | BRF_PRG | CPS1_68K_PROGRAM_BYTESWAP },
	{ "kod.18",        0x080000, 0x3e4b7295, BRF_ESS | BRF_PRG | CPS1_68K_PROGRAM_BYTESWAP },
	...
	{ "kod.15",        0x010000, 0x01cae60c, BRF_PRG | CPS1_Z80_PROGRAM },
...
static const struct GameConfig ConfigTable[] =
{
	...
	{ "sf2m3"   , CPS_B_21_DEF, mapper_S9263B, 0, NULL                },
	...
	{ "sfzch"   , CPS_B_21_DEF, mapper_cps2  , 0, NULL                },
...
struct BurnDriverD BurnDrvCpsKodb = {
	"kodb", "kod", NULL, "1991",
	"The King of Dragons (bootleg)\0", "No Sprites", "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
...
struct BurnDriverD BurnDrvCpsSf2b = {
	"sf2b", "sf2", NULL, "1991",
	"Street Fighter II - the world warrior (bootleg)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_CAPCOM_CPS1,
...
struct BurnDriverD BurnDrvCpsSf2m1 = {
	...
	"Street Fighter II' - champion edition (Hack - M-1)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_CAPCOM_CPS1,
	NULL, Sf2m1RomInfo, Sf2m1RomName, Sf2yycInputInfo, Sf2DIPInfo,
	Sf2ceInit, DrvExit, Cps1Frame, CpsRedraw, CpsAreaScan,
	&CpsRecalcPal, 384, 224, 4, 3
};
...
struct BurnDriverD BurnDrvCpsSf2m3 = {
	"sf2m3", "sf2ce", NULL, "1992",
	"Street Fighter II' - champion edition (Hack - M-3)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_CAPCOM_CPS1,
	NULL, Sf2m3RomInfo, Sf2m3RomName, Sf2yycInputInfo, Sf2DIPInfo,
	Sf2ceInit, DrvExit, Cps1Frame, CpsRedraw, CpsAreaScan,
	&CpsRecalcPal, 384, 224, 4, 3
};
